...
class GUI(QMainWindow):
    def __init__(self,password='qwe123456'):
        ...
        self.actionliulanzhigongxinxi.triggered.connect(self.zzhiyexinxiliulan)
        self.actionzhigongxinxichaxun.triggered.connect(self.yuangongliulan)
        
        self.actionzichananquanchaxun.triggered.connect(self.yuangongtianjia)

        self.actiontuichuxitogn.triggered.connect(self.shangwangliulanxz)
        self.actiond_2.triggered.connect(self.exitx)
    def yuangongliulan(self):
        self.table_show('yuangong')
    def zzhiyexinxiliulan(self):
        self.table_show('zhiyeweihai')
    def shangwangliulanxz(self):
        self.table_insert('zhiyeshangwang')
    def yuangongtianjia(self):
