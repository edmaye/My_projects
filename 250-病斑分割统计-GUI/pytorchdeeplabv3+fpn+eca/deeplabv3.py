...
class uNet(object):
    ...
    #-----------------------------------------#
    _defaults = {
        "model_path"        :   'logs/Epoch54-Total_Loss0.1581-Val_Loss0.1468.pth',
    ...
    def generate(self):
        ...
        self.net = DeepR101V3PlusD_HANet(num_classes=self.num_classes,args=args, criterion=None, criterion_aux=None)
        ...
        if self.num_classes <= 21:
            self.colors = [(0, 0, 0), (255, 0, 255), (0, 128, 0), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128), 
